...
import {
  ...
  useNotification,
  useSyncTokenToServer,
} from '@/features/app/hooks/use-notification';
      ...
      <View className="flex-1 justify-center items-center bg-black/60 px-6">
        ...
        <View className="w-full bg-white rounded-3xl p-6 items-center shadow-xl">
          ...
          <View className="w-16 h-16 bg-blue-100 rounded-full items-center justify-center mb-4">
            <BellRing size={32} color={DefaultColor.base['primary-color-2']} />
          </View>
          ...
          <View className="w-full gap-3">
            <Pressable
              ...
              className="w-full bg-primary-color-2 py-4 rounded-xl items-center"
            >
