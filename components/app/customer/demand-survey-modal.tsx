...
import { X, Sparkles, Check, Globe, Wrench, Clock, Target } from 'lucide-react-native';
...
export const DemandSurveyModal: React.FC<DemandSurveyModalProps> = ({
  ...
  const { data: initialData } = useQueryCrmPreferences(visible && !!user);
  ...
  return (
    <Modal visible={visible} transparent animationType="slide" onRequestClose={onClose}>
      <View className="flex-1 justify-end bg-black/60">
        <View className="max-h-[88%] rounded-t-3xl bg-white flex-col justify-between">
          {/* Header */}
          <View className="flex-row items-center justify-between border-b border-slate-100 px-5 pb-3.5 pt-4">
          ...
          {/* Sticky Bottom Actions with Safe Area Bottom */}
          <View
...
export default DemandSurveyModal;
