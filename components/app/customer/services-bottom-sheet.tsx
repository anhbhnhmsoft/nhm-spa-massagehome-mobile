      ...
      {serviceData && (
        <View className="px-2 pb-8 pt-2">
          ...
          <View className="flex-row items-center mt-2 gap-2">
            ...
            <Text className="text-sm text-slate-500">{serviceData.booking_count.toLocaleString()} {t('services.bookings')}</Text>
          </View>
          ...
          <View className="mt-8">
            <View className="w-full bg-slate-100 rounded-2xl py-4 px-6 flex-row justify-between items-center shadow-lg shadow-slate-300">
