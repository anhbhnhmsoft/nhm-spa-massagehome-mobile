...
export * from './customer/bottom-crm-preferences-modal';
...
>(({ canDelete }, ref) => {
  ...
  return (
    <BottomSheetModal
      ...
      backgroundStyle={{ backgroundColor: '#f5f5f5', borderRadius: 24 }}
      handleIndicatorStyle={{ backgroundColor: '#cbd5e1' }} // Màu cái thanh ngang nhỏ ở trên
    >
      <BottomSheetView
      ...
      >
        <TouchableOpacity
          className={'flex-row items-center border-b border-gray-100 px-5 py-3 pb-4'}
          onPress={() => {
        ...
        <TouchableOpacity
          className={'flex-row items-center px-5 py-3 pb-4'}
          onPress={() => {
            deleteAvatar();
            (ref as any)?.current?.dismiss();
          }}
...
BottomEditAvatar.displayName = 'BottomEditAvatar';
