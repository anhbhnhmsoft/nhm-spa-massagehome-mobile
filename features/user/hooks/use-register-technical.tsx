      ...
      z
        .object({
          nickname: z
            ...
            .max(
              255,
              t('profile.partner_form.error.invalid_nickname_length', { min: 4, max: 255 })
            ),
          referrer_id: z
            .string()
            .optional()
          ...
          experience: z
            .number(t('profile.partner_form.error.invalid_experience', { min: 1, max: 20 }))
          ...
          dob: z
            .string(t('profile.partner_form.error.invalid_dob'))
        ...
        .superRefine((data, ctx) => {
          ...
          if (galleryCount < 3 || galleryCount > 5) {
            ctx.addIssue({
              ...
              message: t('profile.partner_form.error.invalid_ktv_image_display', {
                min: 3,
                max: 5,
              }),
            });
